...
-- Script to toggle aim assist to the head of visible, alive players without forcefields in Roblox

game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "AUTO AIM HACK"; -- Notification Title
    Text = "Your AIM HACK with is now active!"; -- Notification Message
    Duration = 5; -- How long the notification appears (seconds)
})
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "RISK!!!"; -- Notification Title
    Text = "Your account can be banned!!!"; -- Notification Message
    Duration = 5; -- How long the notification appears (seconds)
})
-- Variables
